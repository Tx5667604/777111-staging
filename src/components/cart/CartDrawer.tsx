...
export function CartDrawer() {
  ...
  return (
    <>
      ...
      <button
        onClick={openDrawer}
        className="relative inline-flex items-center justify-center rounded-lg border bg-background shadow-xs h-9 w-9 hover:bg-accent transition-colors"
        aria-label="Кошик"
      >
        <ShoppingCart className="w-4 h-4" />
        {itemCount > 0 && (
          <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-primary text-[10px] font-bold text-primary-foreground flex items-center justify-center shadow-lg">
