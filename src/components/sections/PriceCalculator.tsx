                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <div className="flex items-center gap-3 mt-1 text-sm text-muted-foreground">
                              <span>Деталь: {v.partCost.toLocaleString('uk-UA')} ₴</span>
                              <span>•</span>
                              <span>Робота: {v.laborCost.toLocaleString('uk-UA')} ₴</span>
                            </div>
                          </div>
                    ...
                    <Card className="border-primary/20 bg-gradient-to-br from-orange-50 to-amber-50">
                      <CardContent className="p-6 text-center">
                        ...
                        <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground mb-6">
                          <span>Запчастина: {selectedVariant.partCost.toLocaleString('uk-UA')} ₴</span>
                          <span>•</span>
